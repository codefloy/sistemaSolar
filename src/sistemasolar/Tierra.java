...
public class Tierra extends javax.swing.JFrame {
    ...
    public Tierra() {
        initComponents();
        txttierra.setBackground(new Color(0,0,0,1));
    ...
    private void initComponents() {
        ...
        txttierra = new javax.swing.JTextArea();
        ...
        Titulo.setText("La Tierra");
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 50, 1370, 90));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes2/Tierra.gif"))); // NOI18N
        ...
        txttierra.setColumns(20);
        txttierra.setFont(new java.awt.Font("Monospaced", 1, 18)); // NOI18N
        txttierra.setForeground(new java.awt.Color(255, 255, 255));
        txttierra.setRows(5);
        txttierra.setText("Características generales de la Tierra :\n\nDiámetro\t\t\t: 12,756 km.\nMasa\t\t\t\t: 5.9722 x 1024 kg.\nDensidad\t\t\t: 5.513 g/cm3.\nVolumen\t\t\t\t: 1,083,206,916,846 km3.\nTemperatura mínima/máxima\t: -88°/58° centígrados.");
        txttierra.setBorder(null);
        txttierra.setOpaque(false);
        getContentPane().add(txttierra, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 450, 590, 200));
    ...
    private javax.swing.JTextArea txttierra;
